    ...
    document.addEventListener("click", (e) => {
        if(e.target.matches(activateWatch)){
            realTimeClock = setInterval(() => {
                ...
                document.querySelector(clock).innerHTML = `<h3 class="realTimeClock-title" style="transition: all .2s ease;">${watch}</h3>`;
                ...
                divClock.style.setProperty("transition", "all 1s ease");
            }, 1000);
